...
This directory contains a Python script to extract text from PDF files, specifically set up for extracting text from the Lesser Key of Solomon PDF.
...
# Extract text from Lesser Key of Solomon.pdf
python extract_pdf_text.py "Lesser Key of Solomon.pdf"

# Specify custom output file
python extract_pdf_text.py "Lesser Key of Solomon.pdf" "lesser_key_of_solomon_text.txt"
...
# Specify custom output file
./extract_pdf.sh "Lesser Key of Solomon.pdf" "lesser_key_of_solomon_text.txt"
```
